...
if (!nv_function_exists('nv_menu_bootstrapegov')) {
    ...
    function nv_menu_bootstrapegov($block_config)
    {
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.menu_selectlink_seek.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.menu_selectlink_seek.tpl')) {
        ...
        $xtpl = new XTemplate('global.menu_selectlink_seek.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
