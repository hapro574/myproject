...
if (!nv_function_exists('nv_block_news_egovgroups')) {
    ...
    function nv_block_news_egovgroups($block_config)
    {
        ...
        if (isset($site_mods[$module])) {
            ...
            if (!empty($list)) {
                if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.news_slide.tpl')) {
                    $block_theme = $global_config['module_theme'];
                } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.news_slide.tpl')) {
                ...
                $xtpl = new XTemplate('global.news_slide.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
