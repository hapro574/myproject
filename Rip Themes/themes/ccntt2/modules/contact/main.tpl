...
<div class="page">
    ...
    <!-- END: bodytext -->
    <div class="row">
        <div class="col-sm-12 col-md-24" style="padding-left: 0px;">
            <!-- BEGIN: dep -->
            <div class="panel panel-default" style="border-radius: 0px !important; ">
                <div class="panel-heading" style="border-radius: 0px !important; ">
                    <h3>{DEP.full_name}</h3>
                </div>
        ...
        <div class="col-sm-12 col-md-24"style="padding-left: 0px;">
            <div class="panel panel-primary"style="border-radius: 0px !important; ">
                <div class="panel-heading"style="border-radius: 0px !important; ">{GLANG.feedback}</div>
